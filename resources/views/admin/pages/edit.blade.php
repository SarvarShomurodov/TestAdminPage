...
@section('content')
<div class="card mt-5">
  <h2 class="card-header">Edit Pages</h2>
  <div class="card-body">
    ...
    <form action="{{ route('pages.update',$page->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea
                ...
                id="inputDetail"
                placeholder="Short Description">{{$page->short_description}}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea
                ...
                placeholder="Long Description">{{$page->long_description}}</textarea>
